...
const I18N = {
    ...
    zh: {
		...
		gympup_time: "预计2026.11上旬上线",
		pondthing_time: "预计2027.01中旬上线",
        coming_soon: "敬请期待",
		gympup: "健身小狗（开发中）",
		pondthing: "池中物（开发中）",
        new_project: "其他游戏",
    ...
    en: {
		...
		gympup_time: "Expected release: Early November 2026",
		pondthing_time: "Expected release: Mid-January 2027",
		coming_soon: "Coming Soon",
		gympup: "GymPup (In Development)",
		pondthing: "PondThing (In Development)",
    ...
    ja: {
		...
		gympup_time: "2026年11月上旬リリース予定",
		pondthing_time: "2027年1月中旬リリース予定",
		coming_soon: "お楽しみに",
		gympup: "GymPup（開発中）",
		pondthing: "PondThing（開発中）",
		new_project: "その他のゲーム",
		copyright: "© 2026 bbone. All Rights Reserved.",
		about_title: "プロフィール",
    ...
    "zh-tw": {
		...
		gympup_time: "預計2026年11月上旬上線",
		pondthing_time: "預計2027年1月中旬上線",
		coming_soon: "敬請期待",
		gympup: "健身小狗（開發中）",
		pondthing: "池中物（開發中）",
		new_project: "其他遊戲",
